...
namespace ForemVersionOne.Model
{
    ...
    public partial class SharedUser : IEquatable<SharedUser>, IValidatableObject
    {
        ...
        public SharedUser(string name = default(string), string username = default(string), string twitterUsername = default(string), string githubUsername = default(string), string websiteUrl = default(string), string profileImage = default(string), string profileImage90 = default(string))
        {
            this.Name = name;

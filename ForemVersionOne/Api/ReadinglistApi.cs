...
namespace ForemVersionOne.Api
{
    ...
    public interface IReadinglistApiSync : IApiAccessor
    {
        ...
        List<ArticleIndex> GetReadinglist(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0);
        ...
        ApiResponse<List<ArticleIndex>> GetReadinglistWithHttpInfo(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0);
    ...
    public interface IReadinglistApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<ArticleIndex>> GetReadinglistAsync(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ArticleIndex>>> GetReadinglistWithHttpInfoAsync(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ReadinglistApi : IReadinglistApi
    {
        ...
        /// <returns></returns>
        public ReadinglistApi(ForemVersionOne.Client.Configuration configuration)
        {
        ...
        public ReadinglistApi(ForemVersionOne.Client.ISynchronousClient client, ForemVersionOne.Client.IAsynchronousClient asyncClient, ForemVersionOne.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Readinglist This endpoint allows the client to retrieve a list of articles that were saved to a Users readinglist.         It supports pagination, each page will contain &#x60;30&#x60; articles by default
        /// </summary>
        /// <exception cref="ForemVersionOne.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="page">Pagination page (optional, default to 1)</param>
        /// <param name="perPage">Page size (the number of items to return per page). The default maximum value can be overridden by \&quot;API_PER_PAGE_MAX\&quot; environment variable. (optional, default to 30)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ArticleIndex&gt;</returns>
        public List<ArticleIndex> GetReadinglist(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0)
        {
            ForemVersionOne.Client.ApiResponse<List<ArticleIndex>> localVarResponse = GetReadinglistWithHttpInfo(page, perPage);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ArticleIndex&gt;</returns>
        public ForemVersionOne.Client.ApiResponse<List<ArticleIndex>> GetReadinglistWithHttpInfo(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<List<ArticleIndex>>("/api/readinglist", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ArticleIndex&gt;</returns>
        public async System.Threading.Tasks.Task<List<ArticleIndex>> GetReadinglistAsync(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ForemVersionOne.Client.ApiResponse<List<ArticleIndex>> localVarResponse = await GetReadinglistWithHttpInfoAsync(page, perPage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ArticleIndex&gt;)</returns>
        public async System.Threading.Tasks.Task<ForemVersionOne.Client.ApiResponse<List<ArticleIndex>>> GetReadinglistWithHttpInfoAsync(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ArticleIndex>>("/api/readinglist", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

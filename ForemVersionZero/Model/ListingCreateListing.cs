...
namespace ForemVersionZero.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListingCreate_listing")]
    public partial class ListingCreateListing : IEquatable<ListingCreateListing>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Set it to \&quot;draft\&quot; to create an unpublished listing</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingCreateListing" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListingCreateListing() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingCreateListing" /> class.
        /// </summary>
        /// <param name="title">title (required).</param>
        /// <param name="bodyMarkdown">The body of the listing in Markdown format. (required).</param>
        ...
        /// <param name="organizationId">The id of the organization the user is creating the listing for.  Only users belonging to an organization can assign the listing to it. .</param>
        /// <param name="action">Set it to \&quot;draft\&quot; to create an unpublished listing.</param>
        public ListingCreateListing(string title = default(string), string bodyMarkdown = default(string), ListingCategory category = default(ListingCategory), List<string> tags = default(List<string>), string tagList = default(string), DateTime expiresAt = default(DateTime), bool contactViaConnect = default(bool), string location = default(string), long organizationId = default(long), ActionEnum? action = default(ActionEnum?))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for ListingCreateListing and cannot be null");
            }
            this.Title = title;
            // to ensure "bodyMarkdown" is required (not null)
            if (bodyMarkdown == null)
            {
                throw new ArgumentNullException("bodyMarkdown is a required property for ListingCreateListing and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The id of the organization the user is creating the listing for.  Only users belonging to an organization can assign the listing to it. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListingCreateListing {\n");
        ...
        {
            return this.Equals(input as ListingCreateListing);
        }

        /// <summary>
        /// Returns true if ListingCreateListing instances are equal
        /// </summary>
        /// <param name="input">Instance of ListingCreateListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListingCreateListing input)
        {
            if (input == null)
            {
                return false;

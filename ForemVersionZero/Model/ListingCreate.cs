...
namespace ForemVersionZero.Model
{
    ...
    /// ListingCreate
    /// </summary>
    [DataContract(Name = "ListingCreate")]
    public partial class ListingCreate : IEquatable<ListingCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingCreate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ListingCreate);
        }

        /// <summary>
        /// Returns true if ListingCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of ListingCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListingCreate input)
        {
            if (input == null)
            {
                return false;

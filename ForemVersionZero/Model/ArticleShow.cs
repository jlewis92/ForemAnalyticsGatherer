...
namespace ForemVersionZero.Model
{
    ...
    /// ArticleShow
    /// </summary>
    [DataContract(Name = "ArticleShow")]
    public partial class ArticleShow : IEquatable<ArticleShow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArticleShow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ArticleShow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArticleShow" /> class.
        /// </summary>
        ...
        /// <param name="readablePublishDate">readablePublishDate (required).</param>
        /// <param name="socialImage">socialImage (required).</param>
        ...
        /// <param name="crosspostedAt">crosspostedAt (required).</param>
        /// <param name="publishedAt">publishedAt (required).</param>
        /// <param name="lastCommentAt">lastCommentAt (required).</param>
        ...
        public ArticleShow(string typeOf = default(string), int id = default(int), string title = default(string), string description = default(string), string coverImage = default(string), string readablePublishDate = default(string), string socialImage = default(string), string tagList = default(string), List<string> tags = default(List<string>), string slug = default(string), string path = default(string), string url = default(string), string canonicalUrl = default(string), int commentsCount = default(int), int positiveReactionsCount = default(int), int publicReactionsCount = default(int), DateTime createdAt = default(DateTime), DateTime? editedAt = default(DateTime?), DateTime? crosspostedAt = default(DateTime?), DateTime publishedAt = default(DateTime), DateTime lastCommentAt = default(DateTime), DateTime publishedTimestamp = default(DateTime), string bodyHtml = default(string), string bodyMarkdown = default(string), SharedUser user = default(SharedUser), int readingTimeMinutes = default(int), SharedOrganization organization = default(SharedOrganization), ArticleFlareTag flareTag = default(ArticleFlareTag))
        {
            // to ensure "typeOf" is required (not null)
            if (typeOf == null)
            {
                throw new ArgumentNullException("typeOf is a required property for ArticleShow and cannot be null");
            }
            this.TypeOf = typeOf;
            this.Id = id;
            ...
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for ArticleShow and cannot be null");
            }
            this.Title = title;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for ArticleShow and cannot be null");
            }
            this.Description = description;
            // to ensure "coverImage" is required (not null)
            if (coverImage == null)
            {
                throw new ArgumentNullException("coverImage is a required property for ArticleShow and cannot be null");
            }
            this.CoverImage = coverImage;
            // to ensure "readablePublishDate" is required (not null)
            if (readablePublishDate == null)
            {
                throw new ArgumentNullException("readablePublishDate is a required property for ArticleShow and cannot be null");
            }
            this.ReadablePublishDate = readablePublishDate;
            // to ensure "socialImage" is required (not null)
            if (socialImage == null)
            {
                throw new ArgumentNullException("socialImage is a required property for ArticleShow and cannot be null");
            }
            this.SocialImage = socialImage;
            // to ensure "tagList" is required (not null)
            if (tagList == null)
            {
                throw new ArgumentNullException("tagList is a required property for ArticleShow and cannot be null");
            }
            this.TagList = tagList;
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for ArticleShow and cannot be null");
            }
            this.Tags = tags;
            // to ensure "slug" is required (not null)
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for ArticleShow and cannot be null");
            }
            this.Slug = slug;
            // to ensure "path" is required (not null)
            if (path == null)
            {
                throw new ArgumentNullException("path is a required property for ArticleShow and cannot be null");
            }
            this.Path = path;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for ArticleShow and cannot be null");
            }
            this.Url = url;
            // to ensure "canonicalUrl" is required (not null)
            if (canonicalUrl == null)
            {
                throw new ArgumentNullException("canonicalUrl is a required property for ArticleShow and cannot be null");
            }
            ...
            // to ensure "editedAt" is required (not null)
            if (editedAt == null)
            {
                throw new ArgumentNullException("editedAt is a required property for ArticleShow and cannot be null");
            }
            this.EditedAt = editedAt;
            // to ensure "crosspostedAt" is required (not null)
            if (crosspostedAt == null)
            {
                throw new ArgumentNullException("crosspostedAt is a required property for ArticleShow and cannot be null");
            }
            ...
            if (bodyHtml == null)
            {
                throw new ArgumentNullException("bodyHtml is a required property for ArticleShow and cannot be null");
            }
            this.BodyHtml = bodyHtml;
            // to ensure "bodyMarkdown" is required (not null)
            if (bodyMarkdown == null)
            {
                throw new ArgumentNullException("bodyMarkdown is a required property for ArticleShow and cannot be null");
            }
            this.BodyMarkdown = bodyMarkdown;
            // to ensure "user" is required (not null)
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for ArticleShow and cannot be null");
            }
            this.User = user;
        ...
        /// <summary>
        /// Gets or Sets ReadablePublishDate
        /// </summary>
        [DataMember(Name = "readable_publish_date", IsRequired = true, EmitDefaultValue = true)]
        public string ReadablePublishDate { get; set; }

        /// <summary>
        /// Gets or Sets SocialImage
        /// </summary>
        [DataMember(Name = "social_image", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "edited_at", IsRequired = true, EmitDefaultValue = true)]
        public DateTime? EditedAt { get; set; }

        /// <summary>
        /// Gets or Sets CrosspostedAt
        /// </summary>
        [DataMember(Name = "crossposted_at", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets LastCommentAt
        /// </summary>
        [DataMember(Name = "last_comment_at", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArticleShow {\n");
            sb.Append("  TypeOf: ").Append(TypeOf).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  Title: ").Append(Title).Append("\n");
            sb.Append("  Description: ").Append(Description).Append("\n");
            sb.Append("  CoverImage: ").Append(CoverImage).Append("\n");
            sb.Append("  ReadablePublishDate: ").Append(ReadablePublishDate).Append("\n");
            sb.Append("  SocialImage: ").Append(SocialImage).Append("\n");
            ...
            sb.Append("  CrosspostedAt: ").Append(CrosspostedAt).Append("\n");
            sb.Append("  PublishedAt: ").Append(PublishedAt).Append("\n");
            sb.Append("  LastCommentAt: ").Append(LastCommentAt).Append("\n");
        ...
        {
            return this.Equals(input as ArticleShow);
        }

        /// <summary>
        /// Returns true if ArticleShow instances are equal
        /// </summary>
        /// <param name="input">Instance of ArticleShow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArticleShow input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ReadablePublishDate == input.ReadablePublishDate ||
                    (this.ReadablePublishDate != null &&
                    this.ReadablePublishDate.Equals(input.ReadablePublishDate))
                ) && 
                (
                    this.SocialImage == input.SocialImage ||
                    (this.SocialImage != null &&
                    this.SocialImage.Equals(input.SocialImage))
                ) && 
                (
                ...
                (
                    ...
                    (this.EditedAt != null &&
                    this.EditedAt.Equals(input.EditedAt))
                ) && 
                (
                    this.CrosspostedAt == input.CrosspostedAt ||
                    (this.CrosspostedAt != null &&
                    this.CrosspostedAt.Equals(input.CrosspostedAt))
                ) && 
                (
                ...
                (
                    this.LastCommentAt == input.LastCommentAt ||
                    (this.LastCommentAt != null &&
                    this.LastCommentAt.Equals(input.LastCommentAt))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReadablePublishDate != null)
                {
                    hashCode = (hashCode * 59) + this.ReadablePublishDate.GetHashCode();
                }
                if (this.SocialImage != null)
                {
                    hashCode = (hashCode * 59) + this.SocialImage.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.EditedAt.GetHashCode();
                }
                if (this.CrosspostedAt != null)
                {
                    hashCode = (hashCode * 59) + this.CrosspostedAt.GetHashCode();
                }
                if (this.PublishedAt != null)
                {
                    hashCode = (hashCode * 59) + this.PublishedAt.GetHashCode();
                }
                if (this.LastCommentAt != null)
                {
                    hashCode = (hashCode * 59) + this.LastCommentAt.GetHashCode();
                }

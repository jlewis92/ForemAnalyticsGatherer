...
namespace ForemVersionZero.Api
{
    ...
    public partial class VideosApi : IVideosApi
    {
        ...
        /// <returns></returns>
        public VideosApi(ForemVersionZero.Client.Configuration configuration)
        {
        ...
        public VideosApi(ForemVersionZero.Client.ISynchronousClient client, ForemVersionZero.Client.IAsynchronousClient asyncClient, ForemVersionZero.Client.IReadableConfiguration configuration)
        {
        ...
        public ForemVersionZero.Client.ApiResponse<List<ArticleVideo>> GetArticlesWithVideoWithHttpInfo(int? page = default(int?), int? perPage = default(int?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "VideosApi.GetArticlesWithVideo";
